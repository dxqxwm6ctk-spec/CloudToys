# Cloud Toys — Storefront (standalone)

Fully independent copy of the Cloud Toys storefront. It has no dependency on
any other folder — copy this folder anywhere and it will install and build
on its own.
